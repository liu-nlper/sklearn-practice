...
# 建立模型
rnf_model = RandomForestClassifier(n_estimators=200, max_depth=20)
...
# 预测
print('预测...')
y_pred_train = rnf_model.predict(X_train)
y_pred_test = rnf_model.predict(X_test)
...
print(rnf_model.feature_importances_)
